<template>
  <md-card md-with-hover class='item large-margin-left small-margin-top' >
    <md-card-header>
      <md-layout md-flex>
  ...
  methods: {
    ...
    plotProfitChart(data) {
      ...
      const chartOptions = {
        ...
        rangeSelector: {
          selected: this.charts.profitChart.selectedRange,
          inputEnabled: false,
                  ...
                  switch (e.rangeSelectorButton.type) {
                    case 'month': {
                      if (e.rangeSelectorButton.count == 1)
                        this.charts.profitChart.selectedRange = 0
                      if (e.rangeSelectorButton.count == 3)
                        this.charts.profitChart.selectedRange = 1
                      if (e.rangeSelectorButton.count == 6)
                        this.charts.profitChart.selectedRange = 2

                      return
                    }
                    case 'all': {
                      this.charts.profitChart.selectedRange = 3
                    }
                  }
                }
              }
        ...
        series: [
          {
            ...
            lineColor: '#4DD0E1',
            fillColor: '#b7ecf3',
            name: this.isBtcRate ? 'Profit in BTC' : 'Profit in USD',
