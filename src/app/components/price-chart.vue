  ...
  methods: {
    ...
    plotPriceChart(data) {
      ...
      const chartOptions = {
        ...
        rangeSelector: {
          selected: this.charts.priceChart.selectedRange,
          inputEnabled: false,
                  ...
                  switch (e.rangeSelectorButton.type) {
                    case 'month': {
                      if (e.rangeSelectorButton.count == 1)
                        this.charts.priceChart.selectedRange = 0
                      if (e.rangeSelectorButton.count == 3)
                        this.charts.priceChart.selectedRange = 1
                      if (e.rangeSelectorButton.count == 6)
                        this.charts.priceChart.selectedRange = 2

                      return
                    }
                    case 'all': {
                      this.charts.priceChart.selectedRange = 3
                    }
                  }
                }
              }
